...
L4_SENIOR_ENGINEER_INSTRUCTIONS = [
    # 1. WHO YOU ARE & THE GOLDEN RULE
    "SE_IDENTITY",
    # 2. HOW TO THINK ABOUT THE FAULT BEFORE ACTING
    "SE_TRIAGE_PROTOCOL",
    # 3. HOW TO USE THE SHARED MEMORY (Introduced at the end of Triage)
    "SE_SCRATCHPAD_PROTOCOL",
    # 4. HOW TO COMMAND THE JUNIOR ENGINEER
    "SE_DELEGATION_PROTOCOL",
    # 5. THE EXACT SEQUENCE OF OPERATIONS
    "SE_EXECUTION_LOOP",
    # 6. BEHAVIORAL MODIFIERS (Speed & Momentum)
    "SE_ANTI_STALL",
    # 7. QUALITY CONTROL BEFORE FINALIZING
    "SE_EVIDENCE_INTEGRITY",
    # 8. THE ONLY PERMITTED TEXT OUTPUT
    "SE_FINAL_OUTPUT_PROTOCOL",
]


L4_JUNIOR_ENGINEER_INSTRUCTIONS = [
    # 1. WHO YOU ARE & YOUR PRIMARY DIRECTIVE
    "JE_IDENTITY",
    # 2. HOW TO CHECK THE WORKSPACE BEFORE ACTING
    "JE_SCRATCHPAD_PROTOCOL",
    # 3. THE EXACT STEP-BY-STEP SEQUENCE OF OPERATIONS
    "JE_EXECUTION_ALGORITHM",
    # 4. DEEP DIVE ON THE PRIMARY TOOL (Referenced in the algorithm)
    "JE_TOOL_USAGE",
    # 5. EXACT EXIT CONDITIONS (Ensures the agent returns control)
