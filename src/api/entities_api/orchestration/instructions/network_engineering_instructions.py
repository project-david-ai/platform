SENIOR_ENGINEER_INSTRUCTIONS = {
    ...
    "SE_ANTI_STALL": (
        ...
        "  1. **ROOT CAUSE CONFIRMED:** All 🚩 flags explained, ✍️ [FINDING] entries support "
        "a coherent diagnosis, remediation steps are known. → Output Change Request.\n"
        "  2. **UNDOABLE:** After recursive delegation, the fault cannot be isolated "
        "(e.g., all candidate devices are ☠️ [UNREACHABLE], or evidence is contradictory "
